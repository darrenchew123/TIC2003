...
public:
    ...
    static void handleVariableSelectType(const string& conditionType, bool isT, const string& selectVar, const string& selectType, const string& leftArg, const string& rightArg, const string& patternType, const string& patternLeftArg,const string& patternRightArg, bool isSubexpression, vector<string>& databaseResults, Query& queryToExecute);    static void handleConstantSelectType( string conditionType,bool isT, const string& selectVar, const string& selectType, const string& leftArg, const string& rightArg, vector<string>& databaseResults, Query& queryToExecute);
